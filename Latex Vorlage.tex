...
\newcommand{\Lehrveranstaltung}{Physikalisches Anfängerpraktikum}
\newcommand{\Universitaet}{Universität Augsburg}
\newcommand{\Semester}{Wintersemester 2025/2026}
\newcommand{\Versuchsnummer}{M1}
\newcommand{\Versuchstitel}{Drehpendel}
\newcommand{\Gruppe}{G01}
\newcommand{\Versuchsdatum}{TT.MM.JJJJ}
...
\newcommand{\Autor}{Max Mustermann, Erika Beispiel}
...
Hier folgt die Einleitung zum Versuch. Sie ordnet den Versuch in einen aktuellen Kontext ein, beschreibt die Relevanz und formuliert das Ziel der Messungen. [file:1]
